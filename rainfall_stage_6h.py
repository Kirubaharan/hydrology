...
rain_df = rain_df.resample('6H', how=np.sum)
...
#aggregate daily
water_level_1 = water_level_1.resample('6H', how=np.mean)
# print water_level_1
...
#aggregate daily
water_level_2 = water_level_2.resample('6H', how=np.mean)
# print water_level_2
...
#aggregate daily
water_level_3 = water_level_3.resample('6H', how=np.mean)
# print water_level_3
...
plt.title(r"Average 6 Hourly Water Level in Checkdam 591", fontsize=16)
plt.legend(loc='upper left')
fig.autofmt_xdate(rotation=90)
plt.savefig('/media/kiruba/New Volume/ACCUWA_Data/python_plots/check_dam_evap/six_hour_stage_591')