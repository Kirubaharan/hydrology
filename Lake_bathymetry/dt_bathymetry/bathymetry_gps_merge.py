...
gps_way_point_file = input_folder + '/gps_waypoint_combined_utm.csv'
gps_way_point_df = pd.read_csv(gps_way_point_file)
print gps_way_point_df.head()
gps_way_point_df = gps_way_point_df[['ele,N,24,15', 'time,D', 'name,C,254', 'latitude,N,21,6', 'longitude,N,21,6']]
survey_file = input_folder + '/survey_data_combined.csv'
...
merged_df.to_csv(input_folder + '/dt_bathymetry.csv')