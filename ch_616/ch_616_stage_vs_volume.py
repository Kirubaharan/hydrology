...
#input parameters
base_file = '/media/kiruba/New Volume/ACCUWA_Data/Checkdam_water_balance/ch_616/created_profile_616.csv'
check_dam_no = 616
check_dam_height = 1.1    # m
df_616 = pd.read_csv(base_file, sep=',')
# print df_616
df_616_trans = df_616.iloc[0:,2:]  # Transpose
...
y_name_list = []
for y_value in df_616_trans.columns:
    y_name_list.append(('Y_%s' %y_value))

df_616_trans.columns = y_name_list
# print df_591_trans
y_value_list = df_616_trans.ix[0, 1:]
print y_value_list

# drop the y values from data
final_data = df_616_trans.ix[1:, 0:]
print final_data
...
print stage_vol_df
stage_vol_df.to_csv('/media/kiruba/New Volume/ACCUWA_Data/Checkdam_water_balance/ch_616/stage_vol.csv')
fig = plt.figure()
