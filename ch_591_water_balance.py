...
"""
dry_water_balance_df = water_balance_df[water_balance_df['Rain Collection (mm)'] == 0]
rain_water_balance_df = water_balance_df[water_balance_df['Rain Collection (mm)'] > 0]
"""
