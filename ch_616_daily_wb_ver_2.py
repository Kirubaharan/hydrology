...
x_cal = np.array([1972, 2420, 3282, 4014, 4729, 6168])
...
block_2 = '/media/kiruba/New Volume/ACCUWA_Data/check_dam_water_level/2527/2527_004_002.CSV'
water_level_2 = cd.read_correct_ch_dam_data(block_2, slope, intercept)
block_3 = '/media/kiruba/New Volume/ACCUWA_Data/check_dam_water_level/2527/2527_004_001_2.CSV'
water_level_3 = cd.read_correct_ch_dam_data(block_3, slope, intercept)
block_4 = '/media/kiruba/New Volume/ACCUWA_Data/check_dam_water_level/2527/2527_006_001.CSV'
...
# raise SystemExit(0)
water_level_10min = pd.concat([water_level_6, water_level_7, water_level_8, water_level_9, water_level_10], axis=0)
...
plt.plot(merged_water_balance['Rain Collection (mm)'], merged_water_balance['Inflow (cu.m)'], 'bo')
plt.show()
